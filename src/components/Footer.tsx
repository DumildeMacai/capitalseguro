...
const Footer = () => {
  return (
    <footer className="bg-secondary/10 dark:bg-navy-dark/50 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-muted-foreground mb-4">
              Building a future of financial freedom through smart, passive income investments.
            </p>
            <div className="flex gap-4">
              <a 
                href="#" 
                className="h-10 w-10 flex items-center justify-center rounded-full bg-muted hover:bg-muted-foreground/20 transition-colors"
                aria-label="Twitter"
              >
